...
class StagesShape(LoadTestShape):
    # stages = caculate_stages(start_user=20, end_user=500, user_diff=20, start_duration=300, duration_diff=300, spawn_rate=2)
    # stages = caculate_stages(start_user=5, end_user=500, user_diff=5, start_duration=300, duration_diff=300, spawn_rate=1)
    # stages = caculate_stages(start_user=200, end_user=40000, user_diff=200, start_duration=300, duration_diff=300, spawn_rate=5)
    stages = caculate_stages(start_user=500, end_user=10000, user_diff=500, start_duration=300, duration_diff=300, spawn_rate=10)
    step = {
            "duration": 999999, 
            "users": 10000, 
            "spawn_rate": 10
